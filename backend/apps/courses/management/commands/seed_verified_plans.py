...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        plans = [
            ...
            ('cat', dict(name='Complete CAThlete — Without Mocks', slug='base', price_inr=Decimal('5499'),
                         sort_order=9, includes_live=True, mock_exams_covered=['CAT'],
                         razorpay_sku='cathlete-base')),
            ('cat', dict(name='Complete CAThlete + Mocks', slug='with-mocks', price_inr=Decimal('8499'),
