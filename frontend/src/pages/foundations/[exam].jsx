...
const EXAM_META = {
  xat: { name:'XAT', full:'Xavier Aptitude Test', color:'#5b3fa0', course:'/courses/xat', courseLabel:'Full XAT Course', isFullCourse:false, mocksCheckoutUrl:'/checkout?course=xat&plan=mocks', mocksPrice:'₹1,499' },
