...
const FAQS = [
  ...
  { q:'Can I combine NMAT Mocks with SNAP Mocks?', a:'Yes. The SNAP + NMAT Mocks bundle is available at ₹4,499 — saving ₹1,499 compared to buying them separately. Both exams share significant content in Language, Quantitative, and Reasoning sections.' },
  { q:'Can I add NMAT Mocks to CATalysis?', a:'Yes. NMAT Mocks can be added as an add-on with CATalysis at ₹1,999 (saving ₹1,000). Since NMAT and CAT overlap significantly in content, the combination is very efficient.' },
]
...
export default function NMATPage() {
  return (
    <>
      <PageSEO
        title="NMAT Mocks — GRADSKOOL | ₹2,999 | Mocks + Sectionals + Area-wise Tests"
        ...
        schema={[
          courseSchema({name:'NMAT Mocks',description:"GRADSKOOL NMAT Mocks. 10 full-length mocks, 12 sectional tests, 40 area-wise tests, with detailed analysis reports.",url:'/courses/nmat',price:'2999',mode:['online','asynchronous']}),
          faqSchema(FAQS),
        ]}
      />
      <style>{S}</style>
      ...
      <section style={{ background:'var(--black)', padding:'72px 0 64px', borderBottom:'var(--border)' }}>
        <div className="container">
          <div className="eyebrow" style={{ marginBottom:18, color:'var(--g500)' }}><span className="dot" />NMAT · Mocks · Sectionals · Area-wise Tests</div>
          <h1 className="d-xl" style={{ color:'#fff', marginBottom:18 }}>NMAT Mocks.<br /><em style={R}>Practice that finds your gaps.</em></h1>
          ...
          <div style={{ display:'flex', gap:12, flexWrap:'wrap' }}>
            <Link href="/checkout?course=nmat" className="btn btn-red">Enrol Now — ₹2,999 →</Link>
            <a href="https://wa.me/917838737388?text=Hi%20ALP%20Sir%2C%20I%20want%20to%20know%20about%20NMAT%20Mocks" target="_blank" rel="noopener noreferrer" className="btn btn-ghost">
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:40 }} className="price-layout">
            ...
            <div>
              ...
              <div style={{ background:'var(--off)', border:'var(--border)', borderRadius:4, padding:'28px 32px' }}>
                ...
                {['10 full-length NMAT mocks — real exam interface and timing','12 sectional tests — Language, Quant, Reasoning individually','40 area-wise topic tests for granular practice','Detailed analysis report after every attempt','Percentile estimate and topic-wise weakness tracking','NMAT-specific Data Sufficiency format coverage','No negative marking strategy built into every mock'].map(item => (
      ...
      <div style={{ background:'linear-gradient(135deg,#1a1a18 55%,#2a2927)', padding:'28px 0' }}>
        <div className="container" style={{ display:'flex', alignItems:'center', justifyContent:'space-between', gap:20, flexWrap:'wrap' }}>
          <div>
            ...
            <p style={{ fontFamily:'var(--font-body)', fontSize:14, color:'#fff', lineHeight:1.6 }}>CAThlete — GRADSKOOL's intensive CAT crash course, from ₹6,999. A lot of NMAT students take both.</p>
          </div>
      ...
      <section style={{ background:'var(--black)', padding:'72px 0', textAlign:'center' }}>
        <div className="container">
          <h2 style={{ fontFamily:'var(--font-serif)', fontSize:'clamp(26px,4vw,44px)', fontWeight:400, color:'#fff', marginBottom:14 }}>
            Ready to test yourself?<br /><em style={R}>3 attempts. Start strong.</em>
          </h2>
          <div style={{ display:'flex', gap:12, justifyContent:'center', flexWrap:'wrap', marginTop:24 }}>
            <Link href="/checkout?course=nmat" className="btn btn-red">Enrol Now — ₹2,999 →</Link>
            <a href="https://wa.me/917838737388?text=Hi%20ALP%20Sir%2C%20about%20NMAT" target="_blank" rel="noopener noreferrer" className="btn btn-ghost"><span className="wa-dot" />WhatsApp first</a>
          </div>
        </div>
      </section>
